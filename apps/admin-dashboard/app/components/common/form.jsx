  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
        ...
        return (
          <div key={name}>
            ...
            <input
              ...
              className={`mt-1 block w-full rounded-md border border-border-text px-3 py-2 sm:text-sm focus:outline-none focus:ring-2 focus:ring-pri-text focus:border-pri-text ${{
      ...
      <button
        ...
        className={`btn btn-filled w-full text-center ${(!isFormValid || isSubmitting) ? 'btn-inactive cursor-not-allowed' : ''}`}
      >
